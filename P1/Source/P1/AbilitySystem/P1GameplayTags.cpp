...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Ability_RocketBoots, "Ability.RocketBoots", "Rocket Boots 어빌리티 식별 태그")
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Cooldown_Ability_RocketBoots, "Cooldown.Ability.RocketBoots", "Rocket Boots 쿨다운 GE가 부여하는 태그")
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Ability_ContainmentFence, "Ability.ContainmentFence", "Containment Fence 어빌리티 식별 태그")
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Cooldown_Ability_ContainmentFence, "Cooldown.Ability.ContainmentFence", "Containment Fence 쿨다운 GE가 부여하는 태그")

UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Ability_IonStrike, "Ability.IonStrike", "Ion Strike 어빌리티 식별 태그")
